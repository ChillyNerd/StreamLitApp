...
if penguin_file is None:
    rf_pickle = open(os.path.join(MODELS_PATH, 'random_forest_penguin.pickle'), 'rb')
    map_pickle = open(os.path.join(MODELS_PATH, 'output_penguin.pickle'), 'rb')
    rfc = pickle.load(rf_pickle)
    unique_penguin_mapping = pickle.load(map_pickle)
    rf_pickle.close()
    map_pickle.close()
    penguin_df = pd.read_csv(os.path.join(DATA_PATH, 'penguins.csv'))
else:
